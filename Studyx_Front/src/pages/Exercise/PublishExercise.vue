    ...
    <Contentfield>
        <div>
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>发布测试</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <el-table
            ...
            <template slot-scope="scope">
                <el-button
                size="mini"
                @click="handleEdit(scope.row)">发布测试</el-button>
            </template>
            </el-table-column>
        </el-table>
    </Contentfield>
...
export default {
    ...
    methods:{
        //处理管理测试题目
        handleEdit(row) {
            this.$router.push({path:'/experimentexercise',query:row})
        },
